...
public class WristDesign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wrist_design);
        ...
        eP1 = findViewById(R.id.wrist1);
        eP2 = findViewById(R.id.wrist2);
        eP3 = findViewById(R.id.wrist3);
        eP4 = findViewById(R.id.wrist4);
        eP5 = findViewById(R.id.wrist5);
        eP6 = findViewById(R.id.wrist6);
        eP7 = findViewById(R.id.wrist7);
        eP8 = findViewById(R.id.wrist8);
        eP9 = findViewById(R.id.wrist9);
        eP10 = findViewById(R.id.wrist10);
        ...
        eC1 = findViewById(R.id.wristC1);
        eC2 = findViewById(R.id.wristC2);
        eC3 = findViewById(R.id.wristC3);
        eC4 = findViewById(R.id.wristC4);
        eC5 = findViewById(R.id.wristC5);
        eC6 = findViewById(R.id.wristC6);
        eC7 = findViewById(R.id.wristC7);
        eC8 = findViewById(R.id.wristC8);
        eC9 = findViewById(R.id.wristC9);
        eC10 = findViewById(R.id.wristC10);
        eC11 = findViewById(R.id.wristC11);
        eC12 = findViewById(R.id.wristC12);
        eC13 = findViewById(R.id.wristC13);
        eC14 = findViewById(R.id.wristC14);
        eC15 = findViewById(R.id.wristC15);
        ...
        eHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WristDesign.this, HomeScreen.class);
        ...
        eAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WristDesign.this, Account.class);
                startActivity(intent);
            }
        });
        ...
        eShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WristDesign.this, Share.class);
                startActivity(intent);
            }
        });
    }
